...
def  validate_email_full_no_corrections_soap_sdk_go(is_live: bool, license_key: str) -> None:
    print("\r\n-------------------------------------------------------------------");
    print("Email Validation 3 - ValidateEmailFullNoCorrectionsInput - SOAP SDK");
    print("-------------------------------------------------------------------");
