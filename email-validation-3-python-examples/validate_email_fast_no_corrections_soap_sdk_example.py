...
from validate_email_fast_no_corrections_soap import ValidateEmailFastNoCorrectionsSoap

def  validate_email_fast_no_corrections_soap_sdk_go(is_live: bool, license_key: str) -> None:
    print("\r\n-------------------------------------------------------------------");
    print("Email Validation 3 - ValidateEmailFastNoCorrectionsInput - SOAP SDK");
    print("-------------------------------------------------------------------");
