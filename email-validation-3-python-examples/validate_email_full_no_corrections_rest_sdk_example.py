...
def  validate_email_full_no_corrections_rest_sdk_go(is_live: bool, license_key: str) -> None:
    print("\r\n-------------------------------------------------------------------");
    print("Email Validation 3 - ValidateEmailFullNoCorrectionsInput - REST SDK");
    print("-------------------------------------------------------------------");
