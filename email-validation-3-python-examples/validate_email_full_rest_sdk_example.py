...
from validate_email_full_rest import validate_email_full

def  validate_email_full_rest_sdk_go(is_live: bool, license_key: str) -> None:
    print("\r\n------------------------------------------------------");
    print("Email Validation 3 - ValidateEmailFullInput - REST SDK");
    print("------------------------------------------------------");
