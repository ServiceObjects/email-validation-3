...
{
    public class ValidateEmailFastRestSdkExample
    {
        public static void Go(string licenseKey, bool isLive)
        {
            Console.WriteLine("\r\n------------------------------------------------------");
            Console.WriteLine("Email Validation 3 - ValidateEmailFastInput - REST SDK");
            Console.WriteLine("------------------------------------------------------");
            ...
            Console.WriteLine("\r\n* Input *\r\n");
            Console.WriteLine($"Email Address  : {validateEmailFastInput.EmailAddress}");
            Console.WriteLine($"License Key    : {validateEmailFastInput.LicenseKey}");
            Console.WriteLine($"Is Live        : {validateEmailFastInput.IsLive}");
            Console.WriteLine($"Timeout Seconds: {validateEmailFastInput.TimeoutSeconds}");

            EV3Response response = ValidateEmailFastClient.Invoke(validateEmailFastInput);
