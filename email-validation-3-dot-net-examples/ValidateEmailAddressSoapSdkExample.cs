...
{
    public class ValidateEmailAddressSoapSdkExample
    {
        public static void Go(string licenseKey, bool isLive)
        {
            ...
            ValidateEmailResponse response=  validateEmailAddressValidation.ValidateEmailAddress(EmailAddress,AllowCorrections,Timeout,LicenseKey).Result;

            Console.WriteLine("\r\n* Input *\r\n");
            Console.WriteLine($"Email Address    : {EmailAddress}");
            Console.WriteLine($"License Key      : {licenseKey}");
            Console.WriteLine($"Allow Corrections: {AllowCorrections}");
