...
{
    public class ValidateEmailFastNoCorrectionsRestExample
    {
        public static void Go(string licenseKey, bool isLive)
        {
            Console.WriteLine("\r\n-------------------------------------------------------------------");
            Console.WriteLine("Email Validation 3 - ValidateEmailFastNoCorrectionsInput - REST SDK");
            Console.WriteLine("-------------------------------------------------------------------");

            ValidateEmailFastNoCorrectionsClient.ValidateEmailFastNoCorrectionsInput validateEmailFastNoCorrectionsInput = new
            (
                EmailAddress: "Vick@gmail.com",
            ...
            Console.WriteLine("\r\n* Input *\r\n");
            Console.WriteLine($"Email Address  : {validateEmailFastNoCorrectionsInput.EmailAddress}");
            Console.WriteLine($"License Key    : {validateEmailFastNoCorrectionsInput.LicenseKey}");
            Console.WriteLine($"Is Live        : {validateEmailFastNoCorrectionsInput.IsLive}");
            Console.WriteLine($"Timeout Seconds: {validateEmailFastNoCorrectionsInput.TimeoutSeconds}");

            EV3Response response = ValidateEmailFastNoCorrectionsClient.Invoke(validateEmailFastNoCorrectionsInput);
