...
# Endpoint URLs for EV3 ValidateEmailFull REST API
primary_url = "https://sws.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Full/"
backup_url  = "https://swsbackup.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Full/"
trial_url   = "https://trial.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Full/"
...
def validate_email_full(
    ...
    """
    Call EV3 ValidateEmailFull API to validate an email with full checks (incl. SMTP).
    ...
    # Build endpoint URL (path parameters)
