...
# Endpoint URLs for EV3 ValidateEmailFullNoCorrections REST API
primary_url = "https://sws.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Full/NoCorrections/"
backup_url = "https://swsbackup.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Full/NoCorrections/"
trial_url = "https://trial.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Full/NoCorrections/"


def validate_email_full_no_corrections(
    email_address: str,
    license_key: str,
    is_live: bool = True,
    ...
    """
    Call EV3 ValidateEmailFullNoCorrections API to validate an email with the full suite of tests
    but without applying corrections.
