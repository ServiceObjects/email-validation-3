...
# Endpoint URLs for EV3 ValidateEmailFast REST API
primary_url = "https://sws.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Fast/"
backup_url = "https://swsbackup.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Fast/"
trial_url = "https://trial.serviceobjects.com/ev3/api.svc/JSON/ValidateEmailInfo/Fast/"


def validate_email_fast(
    email_address: str,
    license_key: str,
    is_live: bool = True,
    ...
    """
    Call EV3 ValidateEmailFast API to validate an email quickly with domain & DNS checks.
