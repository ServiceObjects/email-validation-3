...
class ValidateEmailFullSoap:
    ...
    def validate_email_full(self, email_address: str) -> Object:
        """
        Call EV3 ValidateEmailFull SOAP API to retrieve the information.
        ...
        try:
            ...
            response = client.service.ValidateEmailFull(**call_kwargs)
