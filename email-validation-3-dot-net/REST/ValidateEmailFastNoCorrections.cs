...
{
    /// <summary>
    /// Provides functionality to call the ServiceObjects Email Validation 3 REST API's ValidateEmailFastNoCorrections endpoint,
    ...
    /// </summary>
    public class ValidateEmailFastNoCorrectionsClient
    {
        ...
        /// <summary>
        /// Synchronously calls the ValidateEmailFastNoCorrections REST endpoint to validate an email address quickly without corrections,
        ...
        public static EV3Response Invoke(ValidateEmailFastNoCorrectionsInput input)
        {
        ...
        /// <summary>
        /// Asynchronously calls the ValidateEmailFastNoCorrections REST endpoint to validate an email address quickly without corrections,
        /// attempting the primary endpoint first and falling back to the backup if the response is invalid
        /// (Error.TypeCode == "3") in live mode.
        /// </summary>
        /// <param name="input">The input parameters including email address, license key, and service options.</param>
        /// <returns>Deserialized <see cref="EV3Response"/> containing the validation results.</returns>
        public static async Task<EV3Response> InvokeAsync(ValidateEmailFastNoCorrectionsInput input)
        {
            string url = BuildUrl(input, input.IsLive ? LiveBaseUrl : TrialBaseUrl);
        ...
        public static string BuildUrl(ValidateEmailFastNoCorrectionsInput input, string baseUrl)
        {
            var qs = $"JSON/ValidateEmailInfo/Fast/NoCorrections/{HttpUtility.UrlEncode(input.EmailAddress)}/" +
        ...
        /// <summary>
        /// Represents the input parameters for the ValidateEmailFastNoCorrections REST API call.
        /// </summary>
        ...
        public record ValidateEmailFastNoCorrectionsInput(
            string EmailAddress = "",
            string LicenseKey = "",
            bool IsLive = true,
