...
export async function validateEmailFastSoapGo(licenseKey, isLive) {
    console.log("\r\n------------------------------------------------------");
    console.log("Email Validation 3 - ValidateEmailFastInput - SOAP SDK");
    console.log("------------------------------------------------------");
    ...
    try {
        // Initialize the ValidateEmailFastSoap class
        const ev3 = new ValidateEmailFastSoap(emailAddress, licenseKey, isLive)
