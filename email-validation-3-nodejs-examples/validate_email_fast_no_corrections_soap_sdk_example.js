...
export async function validateEmailFastNoCorrectionsSoapGo(licenseKey, isLive) {
    console.log("\r\n-------------------------------------------------------------------");
    console.log("Email Validation 3 - ValidateEmailFastNoCorrectionsInput - SOAP SDK");
    console.log("-------------------------------------------------------------------");
    ...
    try {
        // Initialize the ValidateEmailFastNoCorrectionsSoap class
        const ev3 = new ValidateEmailFastNoCorrectionsSoap(emailAddress, licenseKey, isLive, timeoutSeconds);
