...
export async function validateEmailFullSoapGo(licenseKey, isLive) {
    console.log("\r\n------------------------------------------------------");
    console.log("Email Validation 3 - ValidateEmailFullInput - SOAP SDK");
    console.log("------------------------------------------------------");
    ...
    try {
        // Initialize the ValidateEmailFullSoap class
        const ev3 = new ValidateEmailFullSoap(emailAddress, licenseKey, isLive)
