...
export async function validateEmailFullNoCorrectionsSoapGo(licenseKey, isLive) {
    console.log("\r\n-------------------------------------------------------------------");
    ...
    try {
        ...
        const ev3 = new ValidateEmailFullNoCorrectionsSoap(emailAddress, licenseKey, isLive)
