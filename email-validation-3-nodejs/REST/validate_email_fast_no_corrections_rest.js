...
/**
 * <summary>
 * Constructs a full URL for the ValidateEmailFastNoCorrections API endpoint by combining the base URL
...
const buildUrl = (input, baseUrl) =>
    `${baseUrl}JSON/ValidateEmailInfo/Fast/NoCorrections/${encodeURIComponent(input.EmailAddress)}/` +
...
/**
 * <summary>
 * Provides functionality to call the ServiceObjects Email Validation 3 API's ValidateEmailFastNoCorrections endpoint,
 ...
 * </summary>
 */
const ValidateEmailFastNoCorrectionsClient = {
    /**
     * <summary>
     * Asynchronously invokes the ValidateEmailFastNoCorrections API endpoint, attempting the primary endpoint
    ...
    /**
     * <summary>
     * Synchronously invokes the ValidateEmailFastNoCorrections API endpoint by wrapping the async call
...
export { ValidateEmailFastNoCorrectionsClient, EV3Response };