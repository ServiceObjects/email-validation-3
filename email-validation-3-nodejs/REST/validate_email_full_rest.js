 ...
 * or the Error.Number is not equal to '1'.
 * </summary>
...
/**
 * <summary>
 * Constructs a full URL for the ValidateEmailFull API endpoint by combining the base URL
...
const buildUrl = (input, baseUrl) =>
    `${baseUrl}JSON/ValidateEmailInfo/Full/${encodeURIComponent(input.EmailAddress)}/` +
...
/**
 * <summary>
 * Provides functionality to call the ServiceObjects Email Validation 3 API's ValidateEmailFull endpoint,
 * which corrects, validates, and verifies an email address via a full suite of tests and real-time SMTP checks.
 * </summary>
 */
const ValidateEmailFullClient = {
    /**
     * <summary>
     * Asynchronously invokes the ValidateEmailFull API endpoint, attempting the primary endpoint
    ...
    /**
     * <summary>
     * Synchronously invokes the ValidateEmailFull API endpoint by wrapping the async call
...
export { ValidateEmailFullClient, EV3Response };