...
/**
 * <summary>
 * Constructs a full URL for the ValidateEmailFast API endpoint by combining the base URL
...
const buildUrl = (input, baseUrl) =>
    `${baseUrl}JSON/ValidateEmailInfo/Fast/${encodeURIComponent(input.EmailAddress)}/` +
...
/**
 * <summary>
 * Provides functionality to call the ServiceObjects Email Validation 3 API's ValidateEmailFast endpoint,
 ...
 * </summary>
 */
const ValidateEmailFastClient = {
    /**
     * <summary>
     * Asynchronously invokes the ValidateEmailFast API endpoint, attempting the primary endpoint
    ...
    /**
     * <summary>
     * Synchronously invokes the ValidateEmailFast API endpoint by wrapping the async call
...
export { ValidateEmailFastClient, EV3Response };